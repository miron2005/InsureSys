...
(Добавьте скриншоты или GIF здесь, чтобы продемонстрировать пользовательский интерфейс, например, главную форму, гистограмму или ленточную форму. Загрузите их в репозиторий и свяжите их следующим образом:)





Главная форма: ![Главная форма](screenshots/main_form.png)



Гистограмма: ![Гистограмма зарплат](screenshots/histogram.png)
...
Диаграмма классов: Посмотреть здесь
